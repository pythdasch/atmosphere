...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blog_article', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.content_fr'
        db.add_column(u'blog_article', 'content_fr',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.content_en'
        db.add_column(u'blog_article', 'content_en',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.meta_keywords_fr'
        db.add_column(u'blog_article', 'meta_keywords_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.meta_keywords_en'
        db.add_column(u'blog_article', 'meta_keywords_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.meta_description_fr'
        db.add_column(u'blog_article', 'meta_description_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.meta_description_en'
        db.add_column(u'blog_article', 'meta_description_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Article.image'
        db.alter_column(u'blog_article', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'blog_article', 'title_en')

        # Deleting field 'Article.content_fr'
        db.delete_column(u'blog_article', 'content_fr')

        # Deleting field 'Article.content_en'
        db.delete_column(u'blog_article', 'content_en')

        # Deleting field 'Article.meta_keywords_fr'
        db.delete_column(u'blog_article', 'meta_keywords_fr')

        # Deleting field 'Article.meta_keywords_en'
        db.delete_column(u'blog_article', 'meta_keywords_en')

        # Deleting field 'Article.meta_description_fr'
        db.delete_column(u'blog_article', 'meta_description_fr')

        # Deleting field 'Article.meta_description_en'
        db.delete_column(u'blog_article', 'meta_description_en')


        # Changing field 'Article.image'
        db.alter_column(u'blog_article', 'image', self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100))
